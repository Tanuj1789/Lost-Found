...
$sql="select * from found join users using(email) where itemname='$ke' OR category='$cat' OR subcategory='$subcat' OR location='$loc'";
$result=mysqli_query($conn,$sql); 
echo "<font color='blue'><h2>Reporter details are:</h2></font><br>";
